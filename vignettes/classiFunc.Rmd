...
```
   It is also possible to predict all models in parallel. This can lead to significant speed ups for models using computationally intensive distance metrics.
```{r, eval = FALSE, results='asis'}
# TODO write code
# TODO export parallel functionality to mlr
...
# predict the test data set
ensemble.pred = predict(ensemble.m, newdata = ArrowHead[test_inds,])
